              ...
              <div className="terminal-card p-5 mb-6">
                ...
                <div className="mb-4 p-3 rounded border border-surface-border bg-surface-elevated/30">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1 text-[11px] font-mono text-txt-secondary">
                    ...
                    <p><span className="text-terminal-green font-bold">RMD-Based</span> — Follows IRS Required Minimum Distribution divisor tables. Withdrawals increase as a percentage of portfolio with age. Mandatory from Traditional accounts at 73+. RMDs are mandatory distributions, not spending — excess above your spending needs can be reinvested in taxable accounts.</p>
